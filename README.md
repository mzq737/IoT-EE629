...
2.Created test MySQL database and several tables ![MySQL](./mysql-db.png =200){:width="400px"}
3.Installed Jupyter Notebook for project.![JN](./jynotebook.png =200){:width="400px"}
